...
from src.hello_api.embeddings import process_notes_for_indexing, find_most_similar_note
from src.hello_api.qa import answer_question_with_context
...
async def answer_test_questions() -> List[Dict[str, Any]]:
    """Answer all test questions and return results."""
    results = []
        ...
        for subject, questions in test_set.items():
            ...
            for i, question in enumerate(questions):
                ...
                try:
                    ...
                    # Generate answer
                    answer = await answer_question_with_context(session, question)
...
def save_results_to_yaml(results: List[Dict[str, Any]], file_path="qa_results.yaml"):
...
async def run_qa_pipeline():
    ...
    print("\nStep 2: Answering test questions...")
    results = await answer_test_questions()
